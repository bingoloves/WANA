...
import cn.cqs.library_shape.R;

/**
 * 代码属于:https://qmuiteam.com/android
 * @author Ansen
...
public class AnsenPriorityLinearLayout extends AnsenLinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            final TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.PriorityLinearLayout_Layout);
            priority = a.getInteger(R.styleable.PriorityLinearLayout_Layout_layout_priority, PRIORITY_MINI_CONTENT_PROTECTION);
            miniContentProtectionSize = a.getDimensionPixelSize(R.styleable.PriorityLinearLayout_Layout_layout_miniContentProtectionSize,
                    0);
            a.recycle();
        }
