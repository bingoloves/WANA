...
public class RvItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * </pre>
     */
    private int mDividerColor =  Color.parseColor("#ffe7e9ec");
    /**
     * <pre>
     *      分割线高度
     *          默认2sp
...
//                Log.i("定点", left + ":" + top + ":" + right + ":" + (top + mDividerHeight));
    ...
    public static class Builder{
        private Context mContext;
        RvItemDecoration recyclerViewItemDecoration;
        /**
         * <pre>
         *      方向参数，默认纵向
         *      0x10000000:Vertical纵向
        ...
        public Builder(Context mContext) {
            ...
            recyclerViewItemDecoration = new RvItemDecoration(mContext,mOrientation);
        }
