...
//    public PluginClassLoader(String apkFilePath, String optimizedDirectory, String libraryPath, ClassLoader systemClassLoader) {
//        super(apkFilePath, optimizedDirectory, libraryPath, systemClassLoader);
//    }
    public PluginClassLoader(String packageName,String apkFilePath, String optimizedDirectory, String libraryPath, ClassLoader systemClassLoader) {
        super(apkFilePath, optimizedDirectory, libraryPath, systemClassLoader);
    ...
    protected Class<?> loadClass(String className, boolean resolve) throws ClassNotFoundException {
        ...
        if (!TextUtils.isEmpty(pluginPackageName) && className.contains(pluginPackageName)){
            String subClassName = className.substring(pluginPackageName.length(),className.length());
            if (subClassName.contains(pluginPackageName)){
                Log.e("TAG","pluginPackageName = "+pluginPackageName+"\nclassName = "+className+"\nsubClassName = " + subClassName);
                className = subClassName;
                Log.e("TAG","finally className = "+className);
            }
        }
