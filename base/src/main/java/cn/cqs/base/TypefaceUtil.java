...
public class TypefaceUtil {
     ...
     */
    public static String setKeywordColor(String sourceString, String keyword) {
        String result = "";
     ...
     * @return 返回的是带Html标签的字符串，在使用时要通过Html.fromHtml()转换为Spanned对象再传递给TextView对象
     */
    public static String setKeywordColor(String sourceString, String keyword,String color) {
        String result = "";
        if (sourceString != null && !"".equals(sourceString.trim())) {
            if (keyword != null && !"".equals(keyword.trim())) {
