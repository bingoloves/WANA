...
public final class LogUtils {
    ...
    public static void init(Application application,boolean allowLog) {
        logPrinter.setApplication(application);
     ...
     * @param openLog
     */
    public static void open(boolean openLog){
     ...
     * @param dirName
     */
    public static void setLogFileDirName(@Nullable String dirName){
        logPrinter.setLogFileDirName(dirName);
    }
    /**
     * 设置tag
     *
